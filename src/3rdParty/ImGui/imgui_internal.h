...
{
    bool                    Initialized;
    bool                    FrameScopeActive;                   // Set by NewFrame(), cleared by EndFrame()/Update()
...
namespace ImGui
{
    ...
    // - You are calling ImGui functions after ImGui::EndFrame()/ImGui::Update() and before the next ImGui::NewFrame(), which is also illegal.
    ...
    // Update helpers (those functions don't access any ImGui state!)
